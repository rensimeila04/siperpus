...
<a class="navbar-brand" href="#"><i class="fas fa-book-reader mr-2"></i>  I P U S T E L | Hai, Admin</a>
...
<a class="nav-item nav-link" href="http://localhost/siperpus/login/index.php">Logout</a>
